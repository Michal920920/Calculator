<?php
// source: C:\xampp\htdocs\calculator\app/config/config.neon 
// source: C:\xampp\htdocs\calculator\app/config/config.local.neon 

class Container_cc4f30e43a extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'Nette\ComponentModel\Component' => [['calculatorControl', 'application.1', 'application.3']],
			'Nette\Application\UI\IRenderable' => [['calculatorControl', 'application.1', 'application.3']],
			'Nette\ComponentModel\IContainer' => [['calculatorControl', 'application.1', 'application.3']],
			'Nette\ComponentModel\IComponent' => [['calculatorControl', 'application.1', 'application.3']],
			'Nette\Application\UI\ISignalReceiver' => [['calculatorControl', 'application.1', 'application.3']],
			'Nette\Application\UI\IStatePersistent' => [['calculatorControl', 'application.1', 'application.3']],
			'ArrayAccess' => [['calculatorControl', 'application.1', 'application.3']],
			'App\Components\CalculatorControl' => [['calculatorControl']],
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'C:\xampp\htdocs\calculator\app',
			'wwwDir' => 'C:\xampp\htdocs\calculator\www',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => 'C:\xampp\htdocs\calculator\app/../temp',
		];
	}
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'C:\xampp\htdocs\calculator\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'
		));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('C:\xampp\htdocs\calculator\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\xampp\htdocs\calculator\app/../temp/cache', $this->getService('cache.journal'));
		return $service;
	}
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\ILatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\ILatteFactory {
			...
			public function __construct(Container_cc4f30e43a $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('C:\xampp\htdocs\calculator\app/../temp/cache/latte');
